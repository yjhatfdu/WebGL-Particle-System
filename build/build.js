    ...
    (function (GAME) {
        ...
        (function (PS) {
            ...
            var GpuParticleSystem = (function (_super) {
                ...
                function GpuParticleSystem(particlePerSec, emitSpeed, size, life, lifeVary, sizeVary, sizeLevel, particleType, useTexture, emitterType, useWind, gravity, speedVary) {
                    if (lifeVary === void 0) { lifeVary = 0.1; }
                    if (sizeVary === void 0) { sizeVary = 0.1; }
                    if (sizeLevel === void 0) { sizeLevel = 7; }
